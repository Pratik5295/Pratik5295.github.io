...
async function fetchDataAndFillGrid() {
    ...
    const filePaths = ['tower-defense.txt','demon-spawn.txt','demon-spawn.txt','tower-defense.txt','demon-spawn.txt','demon-spawn.txt']; // List of text file paths containing JSON
